-- VibeNote AI Database Schema (Fixed)
...
-- Create function to calculate word count (marked as immutable)
...
-- Journal entries table (without generated column for now)
...
-- Create trigger to update word count when journal content changes
